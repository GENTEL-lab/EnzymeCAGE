...
pip install torch==2.3.0 -f https://download.pytorch.org/whl/cu121/torch_stable.html
pip install torch-scatter torch-cluster torch-sparse torch-geometric torchvision -f https://data.pyg.org/whl/torch-2.3.0+cu121.html
